...
class PunctualTranslation_Client {
	...
	function parseQuery( $query ) {
		...
		if ( isset($query->query_vars[SPTRANS_QVAR]) && ($query->is_singular == true || ($query->is_home == true && 'page' == get_option( 'show_on_front'))) ) {
			...
			// Manage front page home
			if ( $query->is_home == true && 'page' == get_option( 'show_on_front') ) {
				unset($query->query[SPTRANS_QVAR]);
